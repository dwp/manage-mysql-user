...
* `privileges` - (Optional) If present, current privileges will be revoked and then granted as specified here. Accepts a comma-separated list of valid MySQL privileges and optional table names after a colon. Table name may only contain basic Latin letters, digits 0-9, dollar sign and an underscore See examples below.
